      ...
      <div class="cv-stack">
        ...
        <div class="cv-card cv-side-left-top" style="--rotate: -6deg; --z: 3;">
          ...
          <div class="cv-mini-body">
            ...
            <div class="mini-skills">
              <div class="mini-skill-bar"><div class="mini-skill-fill" style="width:78%; background:#7a50a0;"></div></div>
              <div class="mini-skill-bar"><div class="mini-skill-fill" style="width:55%; background:#7a50a0;"></div></div>
              <div class="mini-skill-bar"><div class="mini-skill-fill" style="width:88%; background:#7a50a0;"></div></div>
            </div>
          </div>
        </div>
          ...
          <div class="cv-main-body">
            <div class="cv-sidebar">
              ...
              <div class="skill-row">
                ...
                <div class="skill-bar-wrap"><div class="skill-fill" style="width:90%;"></div></div>
              </div>
              <div class="skill-row">
                <span class="skill-name">SEO / SEM</span>
                <div class="skill-bar-wrap"><div class="skill-fill" style="width:75%;"></div></div>
              </div>
              <div class="skill-row">
                <span class="skill-name">Analytics</span>
                <div class="skill-bar-wrap"><div class="skill-fill" style="width:85%;"></div></div>
              </div>
              <div class="skill-row">
                <span class="skill-name">Design</span>
                <div class="skill-bar-wrap"><div class="skill-fill" style="width:60%;"></div></div>
              </div>
              <div class="skill-row">
                <span class="skill-name">Content</span>
                <div class="skill-bar-wrap"><div class="skill-fill" style="width:80%;"></div></div>
              </div>
        ...
        <div class="cv-card cv-side-left-bot" style="--rotate: -4deg; --z: 4;">
          ...
          <div class="cv-mini-body">
            ...
            <div class="mini-skills">
              <div class="mini-skill-bar"><div class="mini-skill-fill" style="width:92%; background:#c07030;"></div></div>
              <div class="mini-skill-bar"><div class="mini-skill-fill" style="width:70%; background:#c07030;"></div></div>
            </div>
          </div>
        </div>
